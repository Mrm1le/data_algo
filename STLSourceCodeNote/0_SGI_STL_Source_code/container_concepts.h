...
struct _ReversibleContainer_concept_specification {
  ...
  _ReversibleContainer_requirement_violation(_ReversibleContainer __c) {
    ...
    _ERROR_IN_STL_CONTAINER::__rbegin_iterator_accessor_requirement_violation(
        __c);
    _ERROR_IN_STL_CONTAINER::__rend_iterator_accessor_requirement_violation(
        __c);
    // Requirements on Iterators
    ...
    _BidirectionalIterator_concept_specification<
        const_iter>::_BidirectionalIterator_requirement_violation(const_iter());
...
struct _RandomAccessContainer_concept_specification {
  ...
  _RandomAccessContainer_requirement_violation(_RandomAccessContainer __c) {
    ...
    _STL_ERROR::__element_access_operator_requirement_violation(__c, _TypePtr(),
                                                                Dist());
    // Requirements on Iterators
    ...
    _RandomAccessIterator_concept_specification<
        const_iter>::_RandomAccessIterator_requirement_violation(const_iter());
