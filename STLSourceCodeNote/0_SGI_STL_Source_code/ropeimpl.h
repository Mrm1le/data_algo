...
template <class _CharT, class _Alloc>
rope<_CharT, _Alloc>::_RopeLeaf *rope<_CharT, _Alloc>::_S_leaf_concat_char_iter(
    _RopeLeaf *__r, const _CharT *__iter, size_t __len) {
  size_t __old_len = __r->_M_size;
  _CharT *__new_data =
      (_CharT *)_Data_allocate(_S_rounded_up_size(__old_len + __len));
  _RopeLeaf *__result;
  ...
  __STL_TRY {
    __result =
        _S_new_RopeLeaf(__new_data, __old_len + __len, __r->get_allocator());
  }
...
#endif
  if (__depth > 20 &&
      (__result->_M_size < 1000 || __depth > _RopeRep::_S_max_rope_depth)) {
    _RopeRep *__balanced;
...
rope<_CharT, _Alloc>::_S_concat_char_iter(_RopeRep *__r, const _CharT *__s,
  ...
  if (0 == __r)
    return __STL_ROPE_FROM_UNOWNED_CHAR_PTR(__s, __slen, __r->get_allocator());
  ...
  if (_RopeRep::_S_concat == __r->_M_tag &&
    ...
    if (__right->_M_size + __slen <= _S_copy_max) {
      ...
      __STL_TRY { __result = _S_tree_concat(__left, __nright); }
...
#ifndef __GC
template <class _CharT, class _Alloc>
rope<_CharT, _Alloc>::_RopeRep *rope<_CharT, _Alloc>::_S_destr_concat_char_iter(
  ...
  _RopeRep *__right =
      __STL_ROPE_FROM_UNOWNED_CHAR_PTR(__s, __slen, __r->get_allocator());
  __r->_M_ref_nonnil();
  __STL_TRY { __result = _S_tree_concat(__r, __right); }
  ...
  if (_RopeRep::_S_leaf == __right->_M_tag) {
    if (_RopeRep::_S_leaf == __left->_M_tag) {
      ...
      if (__leftright->_M_size + __right->_M_size <= _S_copy_max) {
        ...
        __STL_TRY { return (_S_tree_concat(__leftleft, __rest)); }
...
template <class _CharT, class _Alloc>
rope<_CharT, _Alloc>::_RopeRep *
rope<_CharT, _Alloc>::_S_substring(_RopeRep *__base, size_t __start,
                                   size_t __endp1) {
  if (0 == __base)
    return 0;
  ...
  case _RopeRep::_S_leaf: {
    ...
    __result =
        _S_new_RopeLeaf(__section, __result_len, __base->get_allocator());
    __result->_M_c_string = 0; // Not eos terminated.
#else
    // We should sometimes create substring node instead.
    __result = __STL_ROPE_FROM_UNOWNED_CHAR_PTR(
        __l->_M_data + __start, __result_len, __base->get_allocator());
#endif
    return __result;
  }
  case _RopeRep::_S_substringfn:
  ...
  case _RopeRep::_S_function: {
    ...
    if (__result_len > __lazy_threshold)
      goto lazy;
    __section = (_CharT *)_Data_allocate(_S_rounded_up_size(__result_len));
    __STL_TRY { (*(__f->_M_fn))(__start, __result_len, __section); }
    __STL_UNWIND(_RopeRep::__STL_FREE_STRING(__section, __result_len,
                                             __base->get_allocator()));
    _S_cond_store_eos(__section[__result_len]);
    return _S_new_RopeLeaf(__section, __result_len, __base->get_allocator());
  }
  }
  /*NOTREACHED*/
  __stl_assert(false);
...
#else
template <class _CharT>
bool _Rope_insert_char_consumer<_CharT>::operator()(const _CharT *__leaf,
                                                    size_t __n) {
  size_t __i;
  //  We assume that formatting is set up correctly for each element.
  for (__i = 0; __i < __n; __i++)
...
__STL_TEMPLATE_NULL
inline bool _Rope_insert_char_consumer<char>::operator()(const char *__leaf,
                                                         size_t __n) {
  size_t __i;
  for (__i = 0; __i < __n; __i++)
    _M_o.put(__leaf[__i]);
...
bool rope<_CharT, _Alloc>::_S_apply_to_pieces(_Rope_char_consumer<_CharT> &__c,
  ...
  case _RopeRep::_S_substringfn: {
    ...
    bool __result;
    _CharT *__buffer = (_CharT *)alloc::allocate(__len * sizeof(_CharT));
    __STL_TRY {
      (*(__f->_M_fn))(__begin, __len, __buffer);
      __result = __c(__buffer, __len);
      alloc::deallocate(__buffer, __len * sizeof(_CharT));
    }
    __STL_UNWIND((alloc::deallocate(__buffer, __len * sizeof(_CharT))))
    return __result;
  }
  default:
    __stl_assert(false);
...
template <class _CharT, class _Alloc>
const unsigned long rope<_CharT, _Alloc>::_S_min_len
...
rope<_CharT, _Alloc>::rope(size_t __n, _CharT __c, const allocator_type &__a)
  ...
  if (0 == __rest) {
    ...
    __STL_TRY { __remainder = _S_new_RopeLeaf(__rest_buffer, __rest, __a); }
...
#else
  if ((__old_c_string = (__GC_CONST _CharT *)_Atomic_swap(
