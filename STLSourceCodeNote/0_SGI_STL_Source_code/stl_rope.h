...
template <class _CharT, class _Alloc>
inline rope<_CharT, _Alloc> identity_element(_Rope_Concat_fn<_CharT, _Alloc>) {
...
public:
  typedef
      typename _Alloc_traits<_CharT, _Allocator>::allocator_type allocator_type;
...
template <class _CharT, class _Alloc> class _Rope_rep_base {
public:
...
public:
  ...
  typedef
      typename _Rope_rep_base<_CharT, _Alloc>::allocator_type allocator_type;
...
public:
  ...
  _Rope_RopeConcatenation(_Rope_RopeRep<_CharT, _Alloc> *__l,
      ...
      : _Rope_RopeRep<_CharT, _Alloc>(_S_concat,
                                      ...
                                      false, __l->_M_size + __r->_M_size, __a),
...
public:
  ...
  typedef
      typename _Rope_rep_base<_CharT, _Alloc>::allocator_type allocator_type;
  _Rope_RopeFunction(char_producer<_CharT> *__f, size_t __size, bool __d,
                     allocator_type __a)
...
public:
  ...
  friend bool operator==
      __STL_NULL_TMPL_ARGS(const _Rope_char_ptr_proxy<_CharT, _Alloc> &__x,
                           const _Rope_char_ptr_proxy<_CharT, _Alloc> &__y);
#endif
...
public:
  ...
  _Rope_const_iterator operator--(int) {
    ...
    defined(__STL_FUNCTION_TMPL_PARTIAL_ORDER)
  template <class _CharT2, class _Alloc2>
...
#else
  friend _Rope_const_iterator<_CharT, _Alloc> operator-
      __STL_NULL_TMPL_ARGS(const _Rope_const_iterator<_CharT, _Alloc> &__x,
                           ptrdiff_t __n);
  friend _Rope_const_iterator<_CharT, _Alloc> operator+
      __STL_NULL_TMPL_ARGS(const _Rope_const_iterator<_CharT, _Alloc> &__x,
                           ptrdiff_t __n);
  friend _Rope_const_iterator<_CharT, _Alloc> operator+
      __STL_NULL_TMPL_ARGS(ptrdiff_t __n,
...
public:
  ...
  _Rope_iterator(rope<_CharT, _Alloc> &__r, size_t __pos);
  ~_Rope_iterator() { _RopeRep::_S_unref(_M_root); }
  ...
  reference operator*() {
    _M_check();
    if (0 == _M_buf_ptr) {
      return _Rope_char_ref_proxy<_CharT, _Alloc>(_M_root_rope, _M_current_pos);
    } else {
      return _Rope_char_ref_proxy<_CharT, _Alloc>(_M_root_rope, _M_current_pos,
                                                  *_M_buf_ptr);
    }
...
#else
  friend bool operator==
      __STL_NULL_TMPL_ARGS(const _Rope_iterator<_CharT, _Alloc> &__x,
                           const _Rope_iterator<_CharT, _Alloc> &__y);
  friend bool operator<
      __STL_NULL_TMPL_ARGS(const _Rope_iterator<_CharT, _Alloc> &__x,
                           const _Rope_iterator<_CharT, _Alloc> &__y);
  friend ptrdiff_t operator-
      __STL_NULL_TMPL_ARGS(const _Rope_iterator<_CharT, _Alloc> &__x,
                           const _Rope_iterator<_CharT, _Alloc> &__y);
  friend _Rope_iterator<_CharT, _Alloc> operator-
      __STL_NULL_TMPL_ARGS(const _Rope_iterator<_CharT, _Alloc> &__x,
                           ptrdiff_t __n);
  friend _Rope_iterator<_CharT, _Alloc> operator+
      __STL_NULL_TMPL_ARGS(const _Rope_iterator<_CharT, _Alloc> &__x,
...
public:
  ...
  _Rope_alloc_base(const allocator_type &__a) : _M_data_allocator(__a) {}
...
public:
  ...
  typedef
      typename _Alloc_traits<_CharT, _Allocator>::allocator_type allocator_type;
  allocator_type get_allocator() const { return allocator_type(); }
  _Rope_alloc_base(_RopeRep *__t, const allocator_type &) : _M_tree_ptr(__t) {}
...
template <class _CharT, class _Alloc> class _Rope_base {
public:
  typedef _Rope_RopeRep<_CharT, _Alloc> _RopeRep;
  typedef _Alloc allocator_type;
  static allocator_type get_allocator() { return allocator_type(); }
...
protected:
  ...
  static _RopeLeaf *_S_new_RopeLeaf(__GC_CONST _CharT *__s, size_t __size,
                                    allocator_type __a) {
#ifdef __STL_USE_STD_ALLOCATORS
...
#define __STL_ROPE_FROM_UNOWNED_CHAR_PTR(__s, __size, __a)                     \
...
#endif
  {
    ...
    __STL_TRY { return _S_new_RopeLeaf(__buf, __size, __a); }
...
private:
  ...
  static const unsigned long _S_min_len[_RopeRep::_S_max_rope_depth + 1];
...
public:
  ...
  rope(const _CharT *__s, const allocator_type &__a = allocator_type())
      : _Base(__STL_ROPE_FROM_UNOWNED_CHAR_PTR(__s, _S_char_ptr_len(__s), __a),
              __a) {}
  ...
  rope(const const_iterator &__s, const const_iterator &__e,
       const allocator_type &__a = allocator_type())
      : _Base(_S_substring(__s._M_root, __s._M_current_pos, __e._M_current_pos),
              __a) {}
  ...
  rope(_CharT __c, const allocator_type &__a = allocator_type()) : _Base(__a) {
    _CharT *__buf = _Data_allocate(_S_rounded_up_size(1));

    construct(__buf, __c);
    __STL_TRY { _M_tree_ptr = _S_new_RopeLeaf(__buf, 1, __a); }
    __STL_UNWIND(_RopeRep::__STL_FREE_STRING(__buf, 1, __a))
  }

  rope(size_t __n, _CharT __c, const allocator_type &__a = allocator_type());

  rope(const allocator_type &__a = allocator_type()) : _Base(0, __a) {}
  ...
  void pop_back() {
    _RopeRep *__old = _M_tree_ptr;
    _M_tree_ptr = _S_substring(_M_tree_ptr, 0, _M_tree_ptr->_M_size - 1);
    _S_unref(__old);
  }
  ...
  _CharT front() const { return _S_fetch(_M_tree_ptr, 0); }
  ...
  void delete_c_str() {
    ...
    if (_RopeRep::_S_leaf == _M_tree_ptr->_M_tag &&
        ((_RopeLeaf *)_M_tree_ptr)->_M_data == _M_tree_ptr->_M_c_string) {
  ...
  const_iterator begin() const { return (const_iterator(_M_tree_ptr, 0)); }
  ...
  const_iterator end() const { return (const_iterator(_M_tree_ptr, size())); }
  ...
  template <class _CharT2, class _Alloc2>
  friend rope<_CharT2, _Alloc2> operator+(const rope<_CharT2, _Alloc2> &__left,
  ...
  friend rope<_CharT2, _Alloc2> operator+(const rope<_CharT2, _Alloc2> &__left,
                                          _CharT2 __right);
#else
  friend rope<_CharT, _Alloc> __STD_QUALIFIER operator+
      __STL_NULL_TMPL_ARGS(const rope<_CharT, _Alloc> &__left,
                           const rope<_CharT, _Alloc> &__right);
  ...
  friend rope<_CharT, _Alloc> __STD_QUALIFIER operator+
      __STL_NULL_TMPL_ARGS(const rope<_CharT, _Alloc> &__left, _CharT __right);
#endif
  ...
  rope &append(const _CharT *__iter, size_t __n) {
    _RopeRep *__result = _S_destr_concat_char_iter(_M_tree_ptr, __iter, __n);
    _S_unref(_M_tree_ptr);
  ...
  rope &append(const _CharT *__s, const _CharT *__e) {
    _RopeRep *__result = _S_destr_concat_char_iter(_M_tree_ptr, __s, __e - __s);
    _S_unref(_M_tree_ptr);
    _M_tree_ptr = __result;
    return *this;
  }
  ...
  rope &append(const_iterator __s, const_iterator __e) {
    ...
    _RopeRep *__result = _S_concat(_M_tree_ptr, (_RopeRep *)__appendee);
    _S_unref(_M_tree_ptr);
    _M_tree_ptr = __result;
    return *this;
  }
  ...
  rope &append(_CharT __c) {
    _RopeRep *__result = _S_destr_concat_char_iter(_M_tree_ptr, &__c, 1);
    _S_unref(_M_tree_ptr);
    _M_tree_ptr = __result;
    return *this;
  }
...
public:
  void insert(size_t __p, const rope &__r) {
    _RopeRep *__result = replace(_M_tree_ptr, __p, __p, __r._M_tree_ptr);
#ifdef __STL_USE_STD_ALLOCATORS
  ...
  void replace(size_t __p, size_t __n, const rope &__r) {
    _RopeRep *__result = replace(_M_tree_ptr, __p, __p + __n, __r._M_tree_ptr);
    _S_unref(_M_tree_ptr);
    _M_tree_ptr = __result;
  }
  ...
  void replace(size_t __p, const rope &__r) { replace(__p, 1, __r); }
  ...
  rope substr(iterator __start) const {
    ...
    return rope<_CharT, _Alloc>(_S_substring(_M_tree_ptr, __pos, __pos + 1));
  }
  ...
  size_type find(const _CharT *__s, size_type __pos = 0) const {
    ...
    const_iterator __result = search(const_begin() + __pos, const_end(), __s,
...
#ifdef __STD_STUFF
  reference operator[](size_type __pos) { return _char_ref_proxy(this, __pos); }
