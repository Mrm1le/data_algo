...
#else
static inline unsigned long _Atomic_swap(unsigned long *__p,
                                         unsigned long __q) {
  unsigned long __result = *__p;
  *__p = __q;
  return __result;
...
template <int __inst> struct _STL_mutex_spin {
...
template <int __inst> unsigned _STL_mutex_spin<__inst>::__last = 0;
