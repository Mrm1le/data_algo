...
void replace(_ForwardIter __first, _ForwardIter __last, const _Tp &__old_value,
  ...
  __STL_REQUIRES_BINARY_OP(
      _OP_EQUAL, bool, typename iterator_traits<_ForwardIter>::value_type, _Tp);
...
_ForwardIter __inplace_stable_partition(_ForwardIter __first,
  ...
  return rotate(
      ...
      __middle,
      __inplace_stable_partition(__middle, __last, __pred, __len - __len / 2));
}
...
_ForwardIter __stable_partition_adaptive(_ForwardIter __first,
  ...
  if (__len <= __buffer_size) {
    ...
    return rotate(
        ...
        __middle,
        __stable_partition_adaptive(__middle, __last, __pred, __len - __len / 2,
                                    __buffer, __buffer_size));
  }
}
...
_OutputIter merge(_InputIter1 __first1, _InputIter1 __last1,
  ...
  __STL_REQUIRES(_InputIter2, _InputIterator);
  __STL_REQUIRES(_OutputIter, _OutputIterator);
  __STL_REQUIRES_SAME_TYPE(typename iterator_traits<_InputIter1>::value_type,
...
inline void __inplace_merge_aux(_BidirectionalIter __first,
  ...
  if (__buf.begin() == 0)
    ...
    __merge_adaptive(__first, __middle, __last, __len1, __len2, __buf.begin(),
...
inline void inplace_merge(_BidirectionalIter __first,
  ...
  __STL_REQUIRES(_BidirectionalIter, _Mutable_BidirectionalIterator);
  __STL_BINARY_FUNCTION_CHECK(
      _Compare, bool, typename iterator_traits<_BidirectionalIter>::value_type,
...
_InputIter find_first_of(_InputIter __first1, _InputIter __last1,
  ...
  __STL_REQUIRES(_ForwardIter, _ForwardIterator);
  __STL_BINARY_FUNCTION_CHECK(
      _BinaryPredicate, bool, typename iterator_traits<_InputIter>::value_type,
      typename iterator_traits<_ForwardIter>::value_type);
...
__find_end(_BidirectionalIter1 __first1, _BidirectionalIter1 __last1,
  ...
  _RevIter1 __rlast1(__first1);
  _RevIter2 __rlast2(__first2);
  _RevIter1 __rresult = search(_RevIter1(__last1), __rlast1, _RevIter2(__last2),
                               __rlast2, __comp);
