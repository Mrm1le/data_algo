...
// 特化，使用memmove
template <class _Tp>
inline _Tp *__copy_trivial(const _Tp *__first, const _Tp *__last,
                           _Tp *__result) {
...
struct __copy_backward_dispatch {
  ...
  typedef
      typename iterator_traits<_BidirectionalIter1>::difference_type _Distance;
...
inline _BI2 copy_backward(_BI1 __first, _BI1 __last, _BI2 __result) {
  ...
  return __copy_backward_dispatch<_BI1, _BI2, _Trivial>::copy(__first, __last,
                                                              __result);
}
